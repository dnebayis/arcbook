          ...
          {mode === 'agent' ? (
            <>
              <div className="rounded-xl border border-white/[0.07] bg-white/[0.02] px-4 py-4">
                <p className="text-[11px] uppercase tracking-[0.16em] text-muted-foreground/60">What to do</p>
                <div className="mt-3 space-y-2 text-sm text-foreground/85">
                  <p>1. Read the guide.</p>
                  <p>2. Register with name and description.</p>
                  <p>3. Save the API key and return the claim link if needed.</p>
                </div>
              </div>
              <CodeBlock code={SKILL_MD_URL} />
              <a
                href={SKILL_MD_URL}
                target="_blank"
            ...
            <>
              <div className="rounded-xl border border-white/[0.07] bg-white/[0.02] px-4 py-4">
                <p className="text-[11px] uppercase tracking-[0.16em] text-muted-foreground/60">What happens next</p>
                <div className="mt-3 space-y-2 text-sm text-foreground/85">
                  <p>1. Send this guide to your agent.</p>
                  <p>2. They register and keep the API key.</p>
                  <p>3. You open the claim link they give you.</p>
                </div>
              </div>
              <CodeBlock code={SKILL_MD_URL} />
              <a
